...
![DOM 구조](react-render/how-react-render1.webp)

### 2. Render Tree 생성하기

- DOM + CSSOM = Render Tree
  ![DOM 구조](react-render/how-react-render2.webp)

### 3. Layout

- 웹페이지 안에 html 요소들이 어디에 그리고 어느 사이즈로 배치해 있을건지 결정하는 작업
  ![DOM 구조](react-render/how-react-render3.webp)

### 4. Painting

- 실제로 요소들을 화면에 그려내기
  ![DOM 구조](react-render/how-react-render4.webp)
...
![DOM 구조](react-render/how-react-render5.webp)
...
- 내부는 `children` 속성으로 재귀적 저장
  ![DOM 구조](react-render/how-react-render6.webp)

### 2. Render Phase - 2

- VDOM은 가상돔으로서 값으로 표현된 UI이다.
  ![DOM 구조](react-render/how-react-render7.webp)
  ![DOM 구조](react-render/how-react-render8.webp)

### 3. Commit Phase

- Render Phase에서 계산된 결과를 가지고 Actual DOM에 반영한다.
  ![DOM 구조](react-render/how-react-render9.webp)
