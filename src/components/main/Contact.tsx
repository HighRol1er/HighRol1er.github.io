    ...
    <div className="flex flex-col gap-4">
      ...
      <CardContent>
        <div className="flex flex-col gap-2">
          <IconMapper Icon={Tag} label={"조성윤"} />
          <IconMapper
            Icon={Mail}
            label="hunterjoe999@gmail.com"
            element={"a"}
            href="hunterjoe999@gmail.com"
          />
          <IconMapper
            Icon={() => (
              <svg
            ...
            label="https://github.com/HighRol1er"
            element="a"
            href="https://github.com/HighRol1er"
          />
          <IconMapper Icon={Phone} label="Censored for privacy" />
        </div>
      </CardContent>
    </div>
  );
