...
const samplePosts = [
  {
    ...
    description:
      "React 19에서 추가된 use() 훅, 서버 컴포넌트 개선, 그리고 다양한 성능 최적화 기능들을 알아봅니다.",
    date: "2026.01.02",
    tags: ["React", "Frontend"],
    readTime: "8분",
  },
  {
    ...
    description:
      "타입스크립트 제네릭의 기초부터 고급 패턴까지, 실무에서 자주 사용하는 패턴들을 정리했습니다.",
    date: "2025.12.28",
  ...
  },
  {
    ...
    description:
      "두 상태 관리 라이브러리의 장단점을 비교하고, 프로젝트에 맞는 선택 기준을 제시합니다.",
    date: "2025.12.20",
    tags: ["React", "State"],
    readTime: "10분",
  },
  {
    ...
    description:
      "Grid의 핵심 개념과 실전 예제를 통해 어떤 레이아웃도 구현할 수 있는 능력을 키워봅시다.",
    date: "2025.12.15",
    tags: ["CSS", "Layout"],
    readTime: "6분",
  },
  {
    ...
    description:
      "Pages Router에서 App Router로 마이그레이션하면서 겪은 이슈들과 해결 방법을 공유합니다.",
    date: "2025.12.10",
    tags: ["Next.js", "회고"],
    readTime: "15분",
  },
  {
    ...
    description:
      "테스트 자동화부터 배포까지, 효율적인 개발 워크플로우를 구축하는 방법을 알아봅니다.",
    date: "2025.12.05",
    tags: ["DevOps", "Git"],
    readTime: "9분",
  },
